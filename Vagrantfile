...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # config.vm.define 'nsc-bootcamp-website' do |node|
  #   node.vm.provision :shell, :path => "provision/bootstrap.sh"
  #   node.vm.hostname = 'nsc-bootcamp-website-hostname'
  #   node.vm.network :private_network, ip: '192.168.50.221'
  #   node.hostmanager.aliases = %w(nsc-bootcamp-website.dev)
  # end
